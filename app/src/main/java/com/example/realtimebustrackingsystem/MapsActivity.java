...
import com.example.realtimebustrackingsystem.databinding.ActivityMapsBinding;
...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback, LocationListener {
    ...
    //stop location sharing btn
    private Button stop_sharing;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        stop_sharing=findViewById(R.id.btn_stop_sharing);
        stop_sharing.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                reference.removeValue();
                Intent intent = new Intent(getApplicationContext(), Driver_location_sharing.class);
                ...
                if (snapshot.exists()) {
                    try {
                        ...
                        if(location!=null){
                            ...
                            markerOptions.position(new LatLng(location.getLatitude(),location.getLongitude())).title(str)
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng zhob = new LatLng(31.3713, 69.4138);
        myMarker=mMap.addMarker(new MarkerOptions().position(zhob).title(str).icon(BitmapFromVector(getApplicationContext(), R.drawable.bus_location)));
        ...
        mMap.moveCamera(CameraUpdateFactory.newLatLng(zhob));
    }
