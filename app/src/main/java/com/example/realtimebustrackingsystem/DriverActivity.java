...
public class DriverActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        driverdata= FirebaseDatabase.getInstance().getReference().child("DriverData");
                ...
                if (dataSnapshot.exists()) {
                    for (DataSnapshot data1 : dataSnapshot.getChildren()) {
                        if (data1.getValue(Data.class).getEmail().equals(str_email)) {
                            dname= data1.getValue(Data.class).getFullname();
    ...
    private void Avatarlist() {
        final Dialog myDialog=new Dialog(DriverActivity.this);
        ...
        avatar1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                CropImage.activity().setAspectRatio(1,1).start(DriverActivity.this);
            }
        });
        myDialog.show();
    }
